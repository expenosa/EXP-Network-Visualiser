...
env\scripts\python -m PyInstaller --clean -i src\resources\ffmpeg_icon.ico --version-file src\resources\file_version_info.txt --onefile --collect-all pyvis --collect-all nicegui src\python\network_ui.py
